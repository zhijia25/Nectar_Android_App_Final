...
public class ListKeyPairModel {
    public StringRequest listKeyPair(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
