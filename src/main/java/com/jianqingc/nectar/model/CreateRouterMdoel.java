...
public class CreateRouterMdoel {
    public JsonObjectRequest createRouter(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
