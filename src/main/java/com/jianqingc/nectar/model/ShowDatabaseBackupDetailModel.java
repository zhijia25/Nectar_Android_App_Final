...
public class ShowDatabaseBackupDetailModel {
    public StringRequest showDatabaseBackupDetail(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
