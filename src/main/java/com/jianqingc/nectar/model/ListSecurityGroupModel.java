...
public class ListSecurityGroupModel {
    public StringRequest listSecurityGroup(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
