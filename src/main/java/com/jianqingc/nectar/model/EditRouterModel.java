...
public class EditRouterModel {
    public JsonObjectRequest editRouter(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
