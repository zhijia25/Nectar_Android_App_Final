...
public class CreateNetworkModel {
    public JsonObjectRequest createNetwork(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
