...
public class EditSecurityGroupModel {
    public JsonObjectRequest editSecurityGroup(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
