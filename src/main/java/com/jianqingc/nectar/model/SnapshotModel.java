...
public class SnapshotModel {
    public JsonObjectRequest snapshot(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
