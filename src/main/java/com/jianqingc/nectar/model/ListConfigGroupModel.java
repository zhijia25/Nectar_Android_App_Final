...
public class ListConfigGroupModel {
    public StringRequest listConfigGroup(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
