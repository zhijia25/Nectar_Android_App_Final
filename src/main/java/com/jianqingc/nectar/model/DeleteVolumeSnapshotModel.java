...
public class DeleteVolumeSnapshotModel {
    public StringRequest deleteVolumeSnapshot(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
