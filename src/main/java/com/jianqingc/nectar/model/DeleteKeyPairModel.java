...
public class DeleteKeyPairModel {
    public StringRequest deleteKeyPair(String fullURL, final String token, String kpName, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
