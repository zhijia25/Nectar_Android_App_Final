...
public class ListDatabaseInstancesModel {
    public StringRequest listDatabaseInstances(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
