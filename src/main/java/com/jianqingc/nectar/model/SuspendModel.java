...
public class SuspendModel {
    public JsonObjectRequest suspend(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
