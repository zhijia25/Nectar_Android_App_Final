...
public class DeleteDatabaseBackupModel {
    public StringRequest deleteDatabaseBackup(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
