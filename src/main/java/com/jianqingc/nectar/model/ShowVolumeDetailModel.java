...
public class ShowVolumeDetailModel {
    public StringRequest showVolumeDetail(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
