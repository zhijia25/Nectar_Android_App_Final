...
public class CreateVolumeSnapshotModel {
    public JsonObjectRequest createVolumeSnapshot(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
