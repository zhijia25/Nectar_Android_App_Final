...
public class ListFlavorModel {
    public StringRequest listFlavor(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
