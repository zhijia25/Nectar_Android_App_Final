...
public class EditVolumeSnapshotModel {
    public JsonObjectRequest editVolumeSnapshot(String fullURL, final String token,JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
