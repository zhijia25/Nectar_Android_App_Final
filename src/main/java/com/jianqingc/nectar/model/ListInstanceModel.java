...
public class ListInstanceModel {
    public StringRequest listInstance(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
