...
public class ListClusterTemplateModel {
    public StringRequest listClusterTemplate(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
