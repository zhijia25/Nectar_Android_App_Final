...
public class StopModel {
    public JsonObjectRequest stop(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
