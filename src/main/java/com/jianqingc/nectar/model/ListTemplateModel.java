...
public class ListTemplateModel {
    public StringRequest listTemplate(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
