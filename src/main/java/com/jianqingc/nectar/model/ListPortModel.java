...
public class ListPortModel {
    public StringRequest ListPortModel(String fullURL, final String token, final String networkID, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
