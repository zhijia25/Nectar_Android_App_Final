...
public class ResumeStackModel {
    public JsonObjectRequest resumeStack(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
