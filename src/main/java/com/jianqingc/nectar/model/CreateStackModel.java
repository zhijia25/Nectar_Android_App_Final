...
public class CreateStackModel {
    public JsonObjectRequest createStack(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
