...
public class CreateVolumeModel {
    public JsonObjectRequest createVolume(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
