...
public class StartModel {
    public JsonObjectRequest start(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
