...
public class AttachVolumeModel {
    public JsonObjectRequest attachVolume(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
