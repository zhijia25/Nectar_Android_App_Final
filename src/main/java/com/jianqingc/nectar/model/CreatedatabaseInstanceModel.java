...
public class CreatedatabaseInstanceModel {
    public JsonObjectRequest createdatabaseInstance(String fullURL, final String token, JSONObject json5, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
