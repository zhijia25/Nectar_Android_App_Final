...
public class AttachConfigGroupModel {
    public JsonObjectRequest attachConfigGroup(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
