...
public class PauseModel {
    public JsonObjectRequest pause(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
