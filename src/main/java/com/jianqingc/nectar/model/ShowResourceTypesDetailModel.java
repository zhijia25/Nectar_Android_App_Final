...
public class ShowResourceTypesDetailModel {
    public StringRequest showResourceTypesDetail(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
