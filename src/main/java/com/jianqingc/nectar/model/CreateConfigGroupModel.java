...
public class CreateConfigGroupModel {
    public JsonObjectRequest createConfigGroup(String fullURL, final String token, JSONObject json4, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
