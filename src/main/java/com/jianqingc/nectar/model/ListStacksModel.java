...
public class ListStacksModel {
    public StringRequest listStacks(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
