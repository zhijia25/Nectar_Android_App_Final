...
public class ImportKeyPairModel {
    public JsonObjectRequest importKeyPair(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
