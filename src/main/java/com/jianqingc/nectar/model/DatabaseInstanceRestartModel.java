...
public class DatabaseInstanceRestartModel {
    public JsonObjectRequest databaseInstanceRestart(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
