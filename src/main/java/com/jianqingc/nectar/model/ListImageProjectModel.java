...
public class ListImageProjectModel {
    public StringRequest listImageProject(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
