...
public class CreateObjectFileModel {
    public StringRequest createObjectFile(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
