...
public class DetachConfigGroupModel {
    public JsonObjectRequest detachConfigGroup(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
