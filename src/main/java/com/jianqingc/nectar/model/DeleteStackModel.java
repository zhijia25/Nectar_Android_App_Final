...
public class DeleteStackModel {
    public StringRequest deleteStack(String fullURL, final String token,  final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
