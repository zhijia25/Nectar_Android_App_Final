...
public class ListTemplateVersionsModel {
    public StringRequest listTemplateVersions(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
