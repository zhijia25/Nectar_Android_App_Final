...
public class DetachVolumeModel {
    public StringRequest detachVolume(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
