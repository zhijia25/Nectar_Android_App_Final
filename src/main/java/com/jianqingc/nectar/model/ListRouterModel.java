...
public class ListRouterModel {
    public StringRequest listRouter(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
