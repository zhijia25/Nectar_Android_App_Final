...
public class DeleteModel {
    public JsonObjectRequest delete(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
