...
public class DeleteclusterModel {
    public StringRequest deletecluster(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
