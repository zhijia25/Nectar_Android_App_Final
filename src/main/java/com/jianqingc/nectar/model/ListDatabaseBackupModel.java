...
public class ListDatabaseBackupModel {
    public StringRequest listDatabaseBackup(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
