...
public class CreateInstanceBackupModel {
    public JsonObjectRequest createInstanceBackup(String fullURL, final String token, JSONObject json4, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
