...
public class CreateClusterModel {
    public JsonObjectRequest createCluster(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
