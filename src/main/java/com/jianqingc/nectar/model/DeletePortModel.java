...
public class DeletePortModel {
    public StringRequest deletePort(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
