...
public class DeleteFloatingIPModel {
    public StringRequest deleteFloatingIP(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
