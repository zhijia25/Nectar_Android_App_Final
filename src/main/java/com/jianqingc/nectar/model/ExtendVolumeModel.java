...
public class ExtendVolumeModel {
    public JsonObjectRequest extendVolume(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
