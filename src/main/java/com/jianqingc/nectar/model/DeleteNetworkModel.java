...
public class DeleteNetworkModel {
    public StringRequest deleteNetwork(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
