...
public class SuspendStackModel {
    public JsonObjectRequest suspendStack(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
