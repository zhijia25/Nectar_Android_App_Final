...
public class ResumeModel {
    public JsonObjectRequest resume(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
