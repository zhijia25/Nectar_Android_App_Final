...
public class CreateSecurityGroupModel {
    public JsonObjectRequest createSecurityGroup(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
