...
public class ShowConfigGroupDetailModel {
    public StringRequest showConfigGroupDetail(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
