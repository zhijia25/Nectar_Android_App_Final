...
public class LaunchServerModel {
    public JsonObjectRequest launchServer(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
