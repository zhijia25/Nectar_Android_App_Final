...
public class ResizeDatabaseInstanceVolumeModel {
    public JsonObjectRequest resizeDatabaseInstanceVolume(String fullURL, final String token, JSONObject json3, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
