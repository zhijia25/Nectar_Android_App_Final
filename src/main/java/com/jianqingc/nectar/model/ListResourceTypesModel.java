...
public class ListResourceTypesModel {
    public StringRequest listResourceTypes(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
