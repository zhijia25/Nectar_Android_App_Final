...
public class ListVolumeTypeModel {
    public StringRequest listVolumeType(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
