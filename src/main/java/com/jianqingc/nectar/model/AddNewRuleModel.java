...
public class AddNewRuleModel {
    public JsonObjectRequest addNewRule(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
