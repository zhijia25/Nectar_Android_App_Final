...
public class CreateFloatingIPModel {
    public JsonObjectRequest createFloatingIP(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
