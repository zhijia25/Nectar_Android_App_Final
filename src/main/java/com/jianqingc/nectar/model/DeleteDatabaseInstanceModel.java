...
public class DeleteDatabaseInstanceModel {
    public StringRequest deleteDatabaseInstance(String fullURL, final String token,  final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
