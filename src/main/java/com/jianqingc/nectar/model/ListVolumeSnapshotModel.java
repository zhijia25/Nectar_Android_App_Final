...
public class ListVolumeSnapshotModel {
    public StringRequest listVolumeSnapshot(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
