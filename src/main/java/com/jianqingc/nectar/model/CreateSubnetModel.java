...
public class CreateSubnetModel {
    public JsonObjectRequest createSubnet(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
