...
public class CopyObjectModel {
    public StringRequest copyObject(String fullURL, final String token,final String preContainer, final String preObjectName, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
