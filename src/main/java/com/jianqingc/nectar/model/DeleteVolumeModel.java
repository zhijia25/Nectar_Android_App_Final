...
public class DeleteVolumeModel {
    public StringRequest deleteVolume(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
