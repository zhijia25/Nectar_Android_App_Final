...
public class ShowKeyPairDetailModel {
    public StringRequest showKeyPairDetail(String fullURL, final String token, String kpName, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
