...
public class ListAlarmProjectModel {
    public StringRequest listAlarmProject(String fullURL, final String token, final Context mApplicationContext, final HttpRequest.VolleyCallback callback, final Context context){
