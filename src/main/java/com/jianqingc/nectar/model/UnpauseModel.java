...
public class UnpauseModel {
    public JsonObjectRequest unpause(String fullURL, final String token, JSONObject json, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
