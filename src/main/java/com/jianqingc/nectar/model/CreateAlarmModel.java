...
public class CreateAlarmModel {
    public JsonObjectRequest createAlarm(String fullURL, final String token, JSONObject json1, final Context mApplicationContext, final HttpRequest.VolleyCallback callback){
